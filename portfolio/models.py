...
class Portfolio(models.Model):
    ...
    img = models.ImageField(upload_to='portfolio_images/', verbose_name="Portfolio Image", null=True, blank=True)
    link = models.URLField(max_length=200, verbose_name="Portfolio Link", null=True)
